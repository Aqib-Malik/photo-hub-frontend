...
import { FaDownload, FaUserCircle, FaStar } from 'react-icons/fa';
// import './gallery.css'; // Import your CSS file
// import './templatemo-snapx-photography.css'
// import './owl.css'
...
const Gallery = () => {
  ...
  return (
      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="owl-features owl-carousel"  style={{position: 'relative',  zIndex: '5',}}>
            ...
            <div className="item">
              <div className="thumb">
                <img src="../components/assets/images/featured-03.jpg" alt=""/>
                <div className="hover-effect">
                  <div className="content">
    ...
    // <section classNameName="gallery-section">
    ...
    //         {images.map((image) => (
    //           <div key={image._id} classNameName="col-md-4 mb-4">

    //             <div classNameName="card">

    //               <div classNameName="image-overlay">
    //               <div classNameName="rating-container">
    //                   <ImageRating image={image} />
    //                 </div>

    //                 <span classNameName="photographer-tag">Photographer</span>
                    
    //                 <img src={image.image} classNameName="card-img-top" alt={image.title} />
    //                 <div classNameName="overlay-content">
    //                   <h5 classNameName="card-title">{image.title}</h5>
    //                   <div classNameName="button-container">
    //                     <a href={image.image} download classNameName="btn-download">
    //                       <FaDownload />
    //                     </a>
    //                   </div>
    //                   <div classNameName="image-container">
    //                     <img src={userImage} alt="User" classNameName="img_user" />
    //                   </div>
...
//                     <span className="photographer-tag">Photographer</span>
                    
//                     <img src={image.image} className="card-img-top" alt={image.title} />
//                     <div className="overlay-content">
//                       <h5 className="card-title">{image.title}</h5>
//                       <div className="button-container">
//                         <a href={image.image} download className="btn-download">
//                           <FaDownload />
//                         </a>
//                       </div>
//                       <div className="image-container">
//                         <img src={userImage} alt="User" className="img_user" />
//                       </div>
